            ...
            @endif
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="" method="post" action="{{url('account/tag/update-tag/'.$editTag->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" name="tag_name" value="{{$editTag->tag_name}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
