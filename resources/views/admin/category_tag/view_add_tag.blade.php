            ...
            @endif
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="" method="post" action="{{url('account/tag/add-tag')}}" data-parsley-validate class="form-horizontal form-label-left">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Tag Name<span class="required">*</span>
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" name="tag_name" value="{{ old('tag_name')}}" required="required" class="form-control col-md-7 col-xs-12">
                          <div style="color:#FF0000;">{{$errors->first('tag_name')}}</div>
                        </div>
                      </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <tbody>
                     @forelse($getTag as $tag)
                     <tr>
                          <td>{{ $tag->tag_name }}</td>
                          <td>{{ $tag->created_at }}</td>
                          <td>{{ $tag->updated_at }}</td>
                          <td><a class="btn btn-primary" href="{{url('account/tag/edit-tag/'.$tag->id)}}">Edit</td>
                     </tr>
                     @empty
                     <tr>
