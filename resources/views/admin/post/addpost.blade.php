            ...
            @endif
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                   <form enctype="multipart/form-data" method="post" action="{{route('admin.create.post')}}" data-parsley-validate class="form-horizontal form-label-left">
                       {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="first-name">Slug<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <input type="text" name="slug" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('slug') }}">
                      ...
                      <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="first-name">Meta Description<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <input type="text" name="meta_description" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('meta_description') }}">
                      ...
                      <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="Image">Image<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="Tag">Tag<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <select id="multipleSelect" multiple  style="text-transform:capitalize;" name="tags[]" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="Category">Category<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <select required=""  style="text-transform:capitalize;" name="category_id" class="form-control col-md-7 col-xs-12 categoryfilter">
                            <option value="">--Choose--</option>
                    ...
                    <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="post">Related Post<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12" id="getfiilterrelatedpost">
                      ...
                      <div class="form-group">
                        <label class="col-md-12 col-sm-12 col-xs-12" for="post">Url Select<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12" for="last-name">Body<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <textarea  rows="20" class="form-control col-md-7 col-xs-12" name="body">{{ old('body') }}</textarea>
...
<script type="text/javascript">
    ...
    $('.categoryfilter').change(function(){
          category_id  = $(this).val();
            ...
            $.ajax({
                type: "GET",
                url:'{{url("account/post/filtercategory")}}/'+category_id,
                dataType: 'json',
                success:function(responce)
                {
                    if(responce.success)
                    {
                        $('#getfiilterrelatedpost').html(responce.success);
                        $("#RelatedPost").select2();
                    }
                }
            });
